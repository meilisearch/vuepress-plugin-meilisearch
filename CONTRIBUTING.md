...
A GitHub Action will be triggered and push the package to [NPM](https://www.npmjs.com/package/vuepress-plugin-meilisearch).
...
- The PR title should be accurate and descriptive of the changes. The title of the PR will be indeed automatically added to the next [release changlogs](https://github.com/meilisearch/vuepress-plugin-meilisearch/releases/).
